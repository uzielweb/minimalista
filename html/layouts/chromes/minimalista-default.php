...
$moduleAttribs['class'] = 'module module-default' . ' module-id-' .$module->id . ' module-position-' . $module->position . ' module-name-' . (is_object($module) && isset($module->name) ? $module->name : "empty")  . ' module-layout-' . $moduleLayout . $moduleClassSfx . $moduleClass;
