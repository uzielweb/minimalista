    ...
    <config>
        <fields name="params">
            <fieldset name="options">
                ...
                <!-- logo position -->
                <field name="logo_position" type="list" label="TPL_MINIMALISTA_LOGO_POSITION" description="TPL_MINIMALISTA_LOGO_POSITION_DESC" default="header-navbar">
                    <option value="header-navbar">TPL_MINIMALISTA_LOGO_POSITION_HEADER_NAVBAR</option>
                    <option value="sidebar-left">TPL_MINIMALISTA_LOGO_POSITION_SIDEBAR_LEFT</option>
                    <option value="sidebar-right">TPL_MINIMALISTA_LOGO_POSITION_SIDEBAR_RIGHT</option>
                </field>
                <!-- favicon-->
