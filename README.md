...
- [x] 10.```diff Novo recurso: ```Permite adicionar infinitas posições acima da parte do componente e abaixo da parte do componente
...
- [x] 10.```diff New feature: ``` Allows you to add infinite positions above the component part and below the component part
