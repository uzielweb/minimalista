        ...
        <section id="section-component" class="section-component">
            <div class="container<?php echo $containerFluid; ?>">
                <div class="inner">
                    ...
                    <?php endif;?>
                    <div class="row"> <?php if ($this->countModules('sidebar-left') || ($logo && $logo_position == 'sidebar-left') && $this->countModules('sidebar-left')): ?>
                        ...
                        <div class="component col-12 col<?php echo $mainWidth; ?>">
                            ...
                            <?php endif;?>
                        </div> <?php if ($this->countModules('sidebar-right') || ($logo && $logo_position == 'sidebar-right') && $this->countModules('sidebar-right')): ?>
